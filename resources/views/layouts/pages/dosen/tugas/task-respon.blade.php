...
@section('title')
TaskApps - Data Tugas Kelas {{ $kelas->nama_kelas }}
@endsection
...
<div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>List Data Tugas Kelas {{ $kelas->nama_kelas }}</h2>
                  ...
                  <div class="x_content">
                    ...
                    <p class="text-muted font-13 m-b-30">
                      Klik detail untuk melihat list tugas yang telah dikirim mahasiswa
                    </p>
                    <table id="ListTaskByClass" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>Tugas</th>
                          <th>Jenis</th>
...
@section('js')
    ...
    <script type="text/javascript">
        $(function() {
          $('#ListTaskByClass').DataTable({
              processing: true,
              serverSide: true,
              ajax: '{{ route("d.task.list.respon",$class_id) }}',
              columns: [
                  { data: 'tugas_ke', name: 'tugas_ke' },
                  { data: 'jenis', name: 'jenis' },
                  { data: 'soal', name: 'soal' },
                  { data: 'deskripsi', name: 'deskripsi' },
                  { data: 'tgl_deadline', name: 'tgl_deadline' },
