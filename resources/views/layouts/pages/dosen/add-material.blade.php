...
<div class="row mt-3">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Tambah Materi<small>Untuk kelas tertentu</small></h2>
            ...
            <div class="x_content">
                <br>
                <form method="post" action="{{ route('d.material.save') }}" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                    @csrf
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input value="{{ date('Y-m-d') }}" id="tgl_materi" class="form-control  @error('tgl_materi') is-invalid @enderror" type="date" name="tgl_materi">
                            @error('tgl_materi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <textarea id="nama_materi" class="form-control @error('nama_materi') is-invalid @enderror" rows="3" name="nama_materi"></textarea>
                            @error('nama_materi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <textarea id="rincian_materi" class="form-control @error('rincian_materi') is-invalid @enderror" rows="4" name="rincian_materi"></textarea>
