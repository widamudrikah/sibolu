                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p class="text-muted font-13 m-b-30">
                      Berikut List Data Mahasiswa
                    </p>
                    <table id="ListMahasiswa" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>No</th>
                          <th>Nim</th>
    ...
    @if(session('sukses'))
        <script>
            Swal.fire({
                ...
                title: 'Berhasil update data mahasiswa',
    ...
    @if(session('reset'))
        <script>
            Swal.fire({
                icon: 'success',
                // title: '{{ session('success') }}',
                title: 'Berhasil reset password mahasiswa, password sekarang adalah "idn12345"',
                confirmButtonText: 'Oke',
            });
        </script>
    @endif
