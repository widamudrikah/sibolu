                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p class="text-muted font-13 m-b-30">
                      Berikut List Data Dosen
                    </p>
                    <table id="LecturerList" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>No.</th>
                          <th>Nidn</th>
    ...
    @if(session('reset'))
        <script>
            Swal.fire({
                ...
                title: 'Berhasil reset password dosen, password sekarang adalah "idn12345"',
