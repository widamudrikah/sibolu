                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p class="text-muted font-13 m-b-30">
                      Berikut list kelas perkuliahan
                    </p>
                    <table id="ListKelas" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>No.</th>
                          <th>Tahun</th>
    ...
    <script type="text/javascript">
        $(function() {
          $('#ListKelas').DataTable({
              processing: true,
              serverSide: true,
              ajax: '{{ route("a.class.list") }}',
              columns: [
                  { data: 'no', name: 'no' },
                  { data: 'tahun_id', name: 'tahun_id' },
