...
<div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tugas Terkirim Berdasarkan Kelas</h2>
                  ...
                  <div class="x_content">
                    ...
                    <p class="text-muted font-13 m-b-30">
                      Klik detail untuk untuk melihat tugas terkirim pada kelas
                    </p>
                    <table id="ListTaskSaya" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>No.</th>
                          <th>Kelas</th>
                          <th>Tugas Terkirim</th>
                          <th>Action</th>
                        </tr>
                      </thead>
                      <tbody>
...
@section('js')
    ...
    <script type="text/javascript">
        $(function() {
          $('#ListTaskSaya').DataTable({
              processing: true,
              serverSide: true,
              ajax: '{{ route("m.task.sent.list") }}',
              columns: [
                  { data: 'no', name: 'no' },
                  { data: 'kelas_id', name: 'kelas_id' },
                  { data: 'jumlah_tugas', name: 'jumlah_tugas' },
