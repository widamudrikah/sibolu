...
@section('title')
TaskApps - Tugas Kelas {{ $kelas->nama_kelas }}
@endsection
...
<div class="page-title">
    <div class="title_left">
        <h3>Tugas Kelas {{ $kelas->nama_kelas }}</h3>
    </div>
</div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p class="text-muted font-13 m-b-30">
                      Berikut data tugas untuk kelas {{ $kelas->nama_kelas }}
                    </p>
                    <table id="ListTask" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>Tugas</th>
                          <th>Jenis</th>
    ...
    <script type="text/javascript">
        $(function() {
          $('#ListTask').DataTable({
              processing: true,
              serverSide: true,
              ajax: '{{ route("m.task.class.list",$class_id) }}',
              columns: [
