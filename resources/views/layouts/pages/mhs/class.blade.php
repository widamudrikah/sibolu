                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p class="text-muted font-13 m-b-30">
                      Berikut list data kelas pilihan anda
                    </p>
                    <table id="ListKelasSaya" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <th>No.</th>
                          <th>Dosen</th>
...
@section('js')
    ...
    <script type="text/javascript">
        $(function() {
          $('#ListKelasSaya').DataTable({
              processing: true,
              serverSide: true,
              ajax: '{{ route("m.class.list") }}',
              columns: [
                  { data: 'no', name: 'no' },
