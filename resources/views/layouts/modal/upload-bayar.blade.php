<div class="modal fade" id="uploadbayar{{ $dt->id }}" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('m.bukti.simpan')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body"> 
                    ...
                    <div class="text-left mt-3">
                        ...
                        <input required type="file" id="bukti_transfer" class="form-control" name="bukti" accept="image/jpeg, image/png">
                    </div>
                </div>
