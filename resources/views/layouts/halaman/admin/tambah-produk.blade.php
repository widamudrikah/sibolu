                ...
                <form method="post" action="#">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input value="{{old('nama_ikan')}}" id="nama_ikan" type="text" class="form-control @error('nama_ikan') is-invalid @enderror" name="nama_ikan">
                            @error('nama_ikan')
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input value="{{old('ukuran')}}" id="ukuran" type="text" class="form-control @error('ukuran') is-invalid @enderror" name="ukuran">
                            @error('ukuran')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input value="{{old('harga')}}" id="harga" type="number" class="form-control @error('harga') is-invalid @enderror" name="harga">
                            @error('harga')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input value="{{old('stok')}}" id="stok" type="number" class="form-control @error('stok') is-invalid @enderror" name="stok">
                            @error('stok')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
